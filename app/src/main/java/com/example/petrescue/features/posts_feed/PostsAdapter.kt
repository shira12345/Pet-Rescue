 ...
 *
 * @param currentUserEmail The email of the currently logged-in user, used to show/hide actions.
 ...
 * @param onDeleteClick Lambda invoked when the delete button on a post is clicked.
 */
class PostsAdapter(
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
    ...
    return PostViewHolder(binding, onPostClick, onEditClick, onDeleteClick)
  }
  ...
  class PostViewHolder(
    ...
    fun bind(post: Post, currentUserEmail: String?) {
      ...
      binding.btnDelete.visibility = if (isCreator) View.VISIBLE else View.GONE
